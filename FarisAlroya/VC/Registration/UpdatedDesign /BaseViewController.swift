...
//    }
    ...
    func setupNavigationBarButtons() {
        if self.navigationController?.viewControllers.count ?? 0 > 1 {
            let backImage =  UIImage(named: "Back_Button")?.imageFlippedForRightToLeftLayoutDirection()
//            _isRTL ? UIImage(named: "Back_Button")?.imageFlippedForRightToLeftLayoutDirection() : UIImage(named: "Back_Button")
...
//            backImage.image =  _isRTL ? UIImage(named: "backArrow")?.imageFlippedForRightToLeftLayoutDirection() : UIImage(named: "backArrow")
...
extension BaseViewController {
    ...
    private func compressFile(at fileURL: URL, toMaxSize maxSize: Int64, completion: @escaping (UIImage, CGFloat) -> Void) throws {
        ...
        // Calculate the compression ratio based on the desired max file size
