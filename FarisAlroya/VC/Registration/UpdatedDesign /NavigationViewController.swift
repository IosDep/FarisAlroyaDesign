...
class NavigationController: UINavigationController {
    ...
    override func viewDidLoad() {
        ...
        navigationBar.tintColor = #colorLiteral(red: 0.4336046576, green: 0.4835631251, blue: 0.7567360997, alpha: 1)
...
extension NavigationController: UINavigationControllerDelegate, UIGestureRecognizerDelegate {
    func navigationController(_ navigationController: UINavigationController,
                              ...
                              animated: Bool) {
        navigationController.view.semanticContentAttribute = MOLHLanguage.isRTLLanguage()  ? .forceRightToLeft : .forceLeftToRight
        navigationController.navigationBar.semanticContentAttribute = MOLHLanguage.isRTLLanguage() ? .forceRightToLeft : .forceLeftToRight
